...
$sql = "SELECT b.id, b.user_id, b.month, b.year, b.generated_date, b.excel_file_path, b.pdf_file_path, u.name 
        FROM bill_details b
    ...
    <div class="container">
        ...
        <table id="billTable">
            ...
            <tbody>
                <?php if (empty($bills)): ?>
                    <tr>
                        <td colspan="5" style="text-align: center;">No bills generated yet.</td>
                    </tr>
                <?php else: ?>
