...
// Fetch bill details for the logged-in user
$user_id = $_SESSION['user_id'];
$sql = "SELECT id, month, year, generated_date, excel_file_path, pdf_file_path FROM bill_details WHERE user_id = :user_id ORDER BY generated_date DESC";
...
<head>
    ...
    <title>Salary Bill History</title>
